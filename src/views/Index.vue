...
export default {
  ...
  setup() {
    ...
    const friendlyLinkList: FriendlyLink[] = [
      ...
      {
        name: '投稿入口',
        url: 'https://github.com/DYS763/Api_button/issues/new?assignees=&labels=&template=----.md&title=%5B%E6%8A%95%E7%A8%BF%5D" frameborder= "0" marginwidth= "0" marginheight= "0" style= "border: none; max-width:100%; max-height:100vh',
        background: '#f5c1bb'
      }
    ]
